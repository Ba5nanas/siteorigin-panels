...
function siteorigin_panels_render( $post_id = false, $enqueue_css = true, $panels_data = false ) {
	...
	foreach ( $grids as $gi => $cells ) {
		...
		$row_style_wrapper = siteorigin_panels_start_style_wrapper( 'row', apply_filters('siteorigin_style_attributes_row',$style_attributes,$panels_data['grids'][$gi]), !empty($panels_data['grids'][$gi]['style']) ? $panels_data['grids'][$gi]['style'] : array() );
		...
		foreach ( $cells as $ci => $widgets ) {
			...
			$cell_style_wrapper = siteorigin_panels_start_style_wrapper( 'cell', apply_filters('siteorigin_style_attributes_cell',$panels_data['grids'][$ci]), !empty($panels_data['grids'][$gi]['style']) ? $panels_data['grids'][$gi]['style'] : array() );
			...
			foreach ( $widgets as $pi => $widget_info ) {
				...
				$widget_style_wrapper = siteorigin_panels_start_style_wrapper( 'widget', apply_filters('siteorigin_style_attributes_widget',$panels_data['grids'][$pi]), !empty( $widget_info['panels_info']['style'] ) ? $widget_info['panels_info']['style'] : array() );
